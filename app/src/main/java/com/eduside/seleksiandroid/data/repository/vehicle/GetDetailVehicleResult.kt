...
import com.eduside.seleksiandroid.data.remote.response.GetDetailVehiclesResponse
...
data class GetDetailVehicleResult (
    val error: LiveData<String>,
    val loading: LiveData<Boolean>,
    val listItem: LiveData<GetDetailVehiclesResponse>,
)